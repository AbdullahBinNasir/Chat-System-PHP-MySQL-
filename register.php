...
if(isset($_POST["register"]))
{
    ...
    else
    {
        if($user_object->save_data())
        {
            ...
            $mail->Username   = 'a.dshamsi2207@gmail.com';                     // SMTP username
            $mail->Password   = 'pzgp hsdm hvby gdij';

            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;

            $mail->Port = 587;

            $mail->setFrom('a.dshamsi2207@gmail.com', 'Aptech');

            $mail->addAddress($user_object->getUserEmail());

            $mail->isHTML(true);

            $mail->Subject = 'Registration Verification for Chat System';

            $mail->Body = '
            <p>Thank you for registering for Chat Application Demo.</p>
                <p>This is a verification email, please click the link to verify your email address.</p>
                <p><a href="http://localhost:80/Code/Chat-System/verify.php?code='.$user_object->getUserVerificationCode().'">Click to Verify</a></p>
                <p>Thank you...</p>
            ';
...
<head>
    ...
    <title>Chat System Using PHP And MySQLI By <b>Abdullah Nasir</b></title>
...
<body>
    ...
    <div class="containter">
        <br />
        <br />
        <h1 class="text-center">Chat System Using PHP And MySQLI By <b>Abdullah Nasir</b></h1>
