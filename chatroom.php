...
<body>
    <div class="container">
        <br />
        <h3 class="text-center">Chat System Using PHP And MySQLI By <b>Abdullah Nasir</b></h3>
        <br />
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    ...
                    foreach ($chat_data as $chat) {
                        $from = isset($_SESSION['user_data'][$chat['userid']]) ? 'Me' : $chat['user_name'];
                        $row_class = isset($_SESSION['user_data'][$chat['userid']]) ? 'row justify-content-start' : 'row justify-content-end';
                        $background_class = isset($_SESSION['user_data'][$chat['userid']]) ? 'text-dark alert-light' : 'alert-success';
            ...
            <div class="col-lg-4">
                ...
                ?>
                <input type="hidden" name="login_user_id" id="login_user_id" value="<?php echo htmlspecialchars($login_user_id); ?>" />
                <div class="mt-3 mb-3 text-center">
                    <img src="<?php echo htmlspecialchars($value['profile']); ?>" width="150" class="img-fluid rounded-circle img-thumbnail" />
                    <h3 class="mt-2"><?php echo htmlspecialchars($value['name']); ?></h3>
                            ...
                            foreach ($user_data as $key => $user) {
                                ...
                                if ($user['user_id'] != $login_user_id) {
                                    ...
                                    <a class="list-group-item list-group-item-action">
                                        <img src="' . htmlspecialchars($user["user_profile"]) . '" class="img-fluid rounded-circle img-thumbnail" width="50" />
                                        <span class="ml-1"><strong>' . htmlspecialchars($user["user_name"]) . '</strong></span>
